           ...
           {filteredProduct.map((item,i) => {
                return (
                    ...
                    <div className="w-[40%] h-fit p-3">
                        <div>
                            <img className="w-fit h-fit rounded-md object-cover m-auto" src={item.img} alt="" />  
                        </div>
                    </div>
                    ...
                    <div className="w-[60%] h-[200rem] p-3">
                        ...
                        <div className="w-[3rem] mt-1 flex items-center text-xs px-3 py-1 gap-1 rounded bg-[#388e3c] text-white"><h3 className="">{3}</h3><FaRegStar/>
                       </div>


                       <div className="flex items-center gap-4 mt-5">
                                <button className="flex items-center gap-3 bg-[#ff9e01] p-3 px-8 text-white rounded" onClick={() => addToCartHandler(filteredProduct)}> <BsCart3 /> ADD TO CART</button>
                                <button className="flex items-center gap-3 bg-[#fb641b] p-3 px-13 text-white rounded"><ImPower />BUY NOW</button>
                       </div>
